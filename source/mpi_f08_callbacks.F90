...
module mpi_f08_callbacks
    ...
    abstract interface
        subroutine MPI_Copy_function(oldcomm, comm_keyval, extra_state, attribute_val_in, &
            ...
            integer :: comm_keyval, extra_state, attribute_val_in, attribute_val_out
            integer :: ierror
            logical :: flag
        end subroutine

        subroutine MPI_Delete_function(comm, comm_keyval, attribute_val, extra_state, ierror)
            use mpi_handle_types, only: MPI_Comm
            implicit none
            type(MPI_Comm) :: comm
            integer :: comm_keyval, attribute_val, extra_state, ierror
        end subroutine
        ...
        subroutine MPI_Comm_copy_attr_function(oldcomm, comm_keyval, extra_state, attribute_val_in, &
                                               attribute_val_out, flag, ierror)
        ...
        subroutine MPI_Type_copy_attr_function(oldtype, type_keyval, extra_state, attribute_val_in, &
                                               attribute_val_out, flag, ierror)
            use mpi_global_constants, only: MPI_ADDRESS_KIND
            use mpi_handle_types, only: MPI_Datatype
            implicit none
        ...
        subroutine MPI_Win_copy_attr_function(oldwin, win_keyval, extra_state, attribute_val_in, &
                                              attribute_val_out, flag, ierror)
            use mpi_global_constants, only: MPI_ADDRESS_KIND
        ...
        subroutine MPI_Datarep_conversion_function(userbuf, datatype, count, filebuf, position, extra_state, ierror)
            use iso_c_binding, only: c_ptr
            use mpi_global_constants, only: MPI_ADDRESS_KIND, MPI_OFFSET_KIND
            use mpi_handle_types, only: MPI_Datatype
            implicit none
        ...
        subroutine MPI_Datarep_conversion_function_c(userbuf, datatype, count, filebuf, position, extra_state, ierror)
            use iso_c_binding, only: c_ptr
            use mpi_global_constants, only: MPI_ADDRESS_KIND, MPI_COUNT_KIND, MPI_OFFSET_KIND
            use mpi_handle_types, only: MPI_Datatype
            implicit none
            type(c_ptr), value :: userbuf, filebuf
            type(MPI_Datatype) :: datatype
    ...
    contains
        ...
        subroutine MPI_TYPE_DUP_FN(oldtype, type_keyval, extra_state, attribute_val_in, &
                                   attribute_val_out, flag, ierror)
            use mpi_error_f, only: MPI_SUCCESS
            use mpi_global_constants, only: MPI_ADDRESS_KIND
            use mpi_handle_types, only: MPI_Datatype
        ...
        subroutine MPI_WIN_DUP_FN(oldwin, win_keyval, extra_state, attribute_val_in, &
                                  attribute_val_out, flag, ierror)
            use mpi_error_f, only: MPI_SUCCESS
            use mpi_global_constants, only: MPI_ADDRESS_KIND
            use mpi_handle_types, only: MPI_Win
