module mpi_info_c
    ...
    interface
        subroutine C_MPI_Info_get_nthkey(info_c, n_c, key_c, ierror_c) &
    ...
    interface
        subroutine C_MPI_Info_get_string(info_c, key_c, buflen_c, value_c, flag_c, ierror_c) &
    ...
    interface
        subroutine C_MPI_Info_set(info_c, key_c, value_c, ierror_c) &
