...
#ifdef VAPAA_TEST_HANDLE_COMPAT
    MPI_Datatype expected = VAPAA_MPI_Type_fromint(VAPAA_MPI_INTEGER);
#else
    MPI_Datatype expected = MPI_INTEGER;
#endif
...
{
#ifdef VAPAA_TEST_HANDLE_COMPAT
    *type = (MPI_Fint) VAPAA_MPI_INTEGER;
#else
